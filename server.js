...
mongoose.connect(MONGODB_URI, mongooseOptions)
    ...
    .catch((err) => {
        ...
        console.log('⚠️  Server will continue running with file-based storage as fallback');
    });
...
// Demo-only check deposit page. This route serves the clearly labeled prototype UI;
// it does not process or settle real checks.
app.get('/check-deposit', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'check-deposit.html'));
});
